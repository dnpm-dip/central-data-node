...
* persist submission reports for quarter reports ([03293ab](https://github.com/dnpm-dip/central-data-node/commit/03293ab878c15d80084cbd3403373eb3d80132a2))
...
* Added missing resolution of systemic therapy recommendation "IZ" out of "IM"+"ZS" ([dda4c52](https://github.com/dnpm-dip/central-data-node/commit/dda4c52027b2c18fb324d83faa7a99e4e28b8602))
...
* Confirmations to DIP nodes will now be processed in batches ([#7](https://github.com/dnpm-dip/central-data-node/issues/7)) ([297e69e](https://github.com/dnpm-dip/central-data-node/commit/297e69ea7beca96b416493de68ab103b8c9539ea))
...
* Dummy modification to re-trigger release action ([8e2e63c](https://github.com/dnpm-dip/central-data-node/commit/8e2e63c430ffd443ffc1c9ff2d2bb98f711a64d1))
...
* Multiple simultaneous token fetches resolved (issue [#5](https://github.com/dnpm-dip/central-data-node/issues/5)) ([f47d66e](https://github.com/dnpm-dip/central-data-node/commit/f47d66eb1949ed95025462813875613a2baa2f5b))
* Multiple simultaneous token fetches resolved (issue [#5](https://github.com/dnpm-dip/central-data-node/issues/5)) ([f47d66e](https://github.com/dnpm-dip/central-data-node/commit/f47d66eb1949ed95025462813875613a2baa2f5b))
* Reworked ReportRepository interface and implementation to avoid resetting already submitted SubmissionReports to 'unsubmitted' when submission confirmation fails ([dae65c0](https://github.com/dnpm-dip/central-data-node/commit/dae65c0d858af19db4e8d42a4e2d8d7e850c6b90))
* Some code clean-up -- but in fact just an attempt at debugging release workflow by triggering a new (dummy) release ([e9c60e1](https://github.com/dnpm-dip/central-data-node/commit/e9c60e161fdbb75c56770dc6e34a8ca23770b3a5))


### Continuous Integration

* Minor cleanup, just to try triggering a release ([30b2ea5](https://github.com/dnpm-dip/central-data-node/commit/30b2ea59d6328d5c01e63e5244fa07406bd5d40f))
